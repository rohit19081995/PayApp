 ...
 *     ListAdapter adapter = new FirebaseSearchAdapter<ChatMessage>(this, ChatMessage.class, android.R.layout.two_line_list_item, mRef)
 *     {
 ...
 */
public abstract class FirebaseSearchAdapter<T> extends BaseAdapter implements Filterable {
